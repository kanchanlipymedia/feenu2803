    ...
    <div class="row gr">
        ...
        <div class="col-md-6">
            <div class="nit-main">
                            ...
                            <div class="so">
                                <ul>
                                    ...
                                    <li class="favorite-btn" data-url="<?php echo e(route('update-favorite-status')); ?>"
                                        ...
                                        <?php else: ?> "1" <?php endif; ?>>Favorite<i
                ...
                <div class="ads"><a href="#"><img src="<?php echo e(url('frontend/images/more/ads3.png')); ?>" class="tni"
                            alt=""></a></div>
                <div class="nit-dis">
                    <div class="nit-flex jcsb">
                        <div class="btn-box">
                        ...
                        <div class="app-box">
                            <a href="<?php echo e($game->app_store_link); ?>"><img src="<?php echo e(url('frontend/images/icons/apple.png')); ?>"
                                    alt=""></a>
                            <a href="<?php echo e($game->google_store_link); ?>"><img
                                    src="<?php echo e(url('frontend/images/icons/google-play.png')); ?>" alt=""></a>
                    ...
                    <div class="dis-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 ml-auto">
                                ...
                                <div class="nit-video"><iframe src="<?php echo e($game->walk_through_link); ?>" width="100%"
